...
public class StrukMain25 {
    Scanner sc = new Scanner(System.in);
    
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        Struk25 stk = new Struk25(20);
        StrukMain25 main = new StrukMain25();
    ...
    public void pushPakaian(Struk25 stk) {
        char pilih;
        do {
           ...
           Struk25 d = new Struk25(noTra, tanggal, jumlah, total);
